...
export const eventValidSchema = Yup.object({
  ...
  Included: Yup.array().of(Yup.string()).min(1, "At least one included item is required"),
  notIncluded: Yup.array().of(Yup.string()).min(1, "At least one not included item is required"),
