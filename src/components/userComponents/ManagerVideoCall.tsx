...
const APP_ID = '826d5685bfbc44cba9c88fc2d74c63d8';
...
const ManagerVideoCall=()=>{  const [client] = useState<IAgoraRTCClient>(AgoraRTC.createClient({ mode: 'rtc', codec: 'vp8' }));
...
const handleUserJoined = async (user: any, mediaType: 'audio' | 'video' | 'datachannel') => {
  ...
  if (mediaType === 'video') {
    ...
    newPlayer.className = 'video-container';
