...
//     <tr key={user._id} className="odd:bg-white even:bg-gray-100 hover:bg-blue-50 text-black">
//       <td className="border border-gray-400 p-3">{index + 1}</td>
//       <td className="border border-gray-400 p-3">{`${user.firstName} ${user.lastName}`}</td>
